...
getComboBoxOficinas(){
  this.base.getAll<Combobox>(DataApi.ComboBox,'PrincipalOffices',null).subscribe(x=>{
...
refreshParameters(){
  this.Cargando=true;
  this.params.principalOfficeId='4d339db8-878b-4462-18a2-08d7d06f21dd';
